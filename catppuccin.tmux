...
main() {
  ...
  local show_window
  readonly show_window="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]#[fg=$thm_bg,bg=$thm_pink,nobold,nounderscore,noitalics] #[fg=$thm_fg,bg=$thm_pink] #W #{?client_prefix,#[fg=$thm_red]"
  local show_session
  readonly show_session="#[fg=$thm_green]}#[bg=$thm_gray]#{?client_prefix,#[bg=$thm_red],#[bg=$thm_green]}#[fg=$thm_bg] #[fg=$thm_fg,bg=$thm_green] #S "
  ...
  readonly show_ncspot_track_title="#[fg=$thm_blue,bg=$thm_bg,nobold,nounderscore,noitalics] #[fg=$thm_bg,bg=$thm_blue,nobold,nounderscore,noitalics] #[fg=$thm_fg,bg=$thm_blue] #(${PLUGIN_DIR}/scripts/get_track_title.sh)"
  local show_ncspot_artist
  readonly show_ncspot_artist=" | #[fg=$thm_fg,bg=$thm_blue]#(${PLUGIN_DIR}/scripts/get_artist.sh)"

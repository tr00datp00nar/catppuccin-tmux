...
main() {
  ...
  local show_time
  readonly show_time="#[fg=$thm_teal,bg=$thm_bg,nobold,nounderscore,noitalics]#[fg=$thm_gray,bg=$thm_teal]#(printf $time) #[fg=$thm_teal,bg=$thm_bg,nobold,nounderscore,noitalics]"

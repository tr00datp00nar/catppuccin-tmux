...
main() {
  ...
  readonly show_window_in_window_status_current="#[fg=$thm_fg,bg=$thm_orange] #W #[fg=$thm_bg,bg=$thm_orange] #I#[fg=$thm_orange,bg=$thm_bg]#[fg=$thm_fg,bg=$thm_bg,nobold,nounderscore,noitalics] "

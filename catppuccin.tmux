...
main() {
  ...
  local show_weather
  readonly show_weather="#[fg=$thm_gray,bg=$thm_orange,nobold,nounderscore,noitalics]#[fg=thm_bg,bg=thm_orange]#(cat $datafile) #[fg=$thm_orange,bg=$thm_bg,nobold,nounderscore,noitalics]"
